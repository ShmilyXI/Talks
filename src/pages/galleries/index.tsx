      ...
      <div className="d-container max-w-1128 px-16 pt-16 md:px-32 md:py-32 lg:py-48">
        ...
        <Filter
          ...
          items={[
            ...
            { label: "去我的画廊", value: "goMine" },
          ]}
          onChange={(item) => {
            console.log("item", item);
            if (item.value === "goMine") {
              // router.push('/')
              return;
            }
                    ...
                    <div className="relative">
                      <div className="flex overflow-hidden rounded">
                        <div className="flex-grow relative overflow-hidden min-w-0 w-2/3" style={{ background: item.photoList?.[0]?.theme_color || "#eaeaea" }}>
                          <img
                            src={
                              item.photoList?.[0]?.url ||
                              "data:image/svg+xml;charset=utf-8,%3Csvg xmlns%3D'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg' width%3D'570' height%3D'380'%2F%3E"
                            }
                            width="570"
                            height="380"
                            alt=""
