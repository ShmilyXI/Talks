...
const Index = () => {
  ...
  const [showMMenu, { toggle: toggleMMenu, setLeft: setMMenuLeft }] = useToggle();
  const [showUserMenu, { toggle: toggleUserMenu, setLeft: setUserMenuLeft }] = useToggle();
  const [showWrap, { toggle: toggleWrap, setLeft: setWrapLeft }] = useToggle();
  const [showMInputTypeMenu, { toggle: toggleMInputTypeMenu, setLeft: setMInputTypeMenuLeft, setRight: setMInputTypeMenuRight }] = useToggle();
  const [showPCInputTypeMenu, { toggle: togglePCInputTypeMenu, setLeft: setPCInputTypeMenuLeft, setRight: setPCInputTypeMenuRight }] = useToggle();

  const [showAddPhotoModal, { toggle: toggleAddPhotoModal, setLeft: setAddPhotoModalLeft }] = useToggle(false); // 是否展示添加照片弹窗
    ...
    <div className="d-container navbar bg-white px-0 md:px-32 z-60 shadow-navbar fixed w-full pin-t md:shadow-none" id="top">
      ...
      <div className={classnames("bg-black shadow-navbar pin-t pin-x absolute lg:hidden z-1", { hidden: !showWrap })} ref={wrapRef}>
        <div className="d-container px-0 flex items-center shadow-navbar-inner">
          <button type="button" className="button-reset py-20 text-white text-24 leading-none lg:hidden text-center w-64" onClick={setWrapLeft}>
            ...
            <div className="relative">
              <input
                ...
                onChange={(e) => {
                  ...
                  value ? setMInputTypeMenuRight() : setMInputTypeMenuLeft();
                }}
              />

              <Icon className="icon-search" addClassName="absolute text-14 pin-l pin-y pin-t-center ml-16 text-grey-27" />
              <div
                className={classnames("search-dropdown bg-white leading-6 rounded shadow-popover absolute pin-x pin-t-full mt-8 overflow-hidden z-50", {
              ...
              >
                <div>
                  ...
                  >
                    <Icon className="icon-pic" addClassName="text-14 w-16 mr-8 text-black" />
                ...
                <div className="border-t border-grey-90">
                  ...
                  >
                    <Icon className="icon-people" addClassName="text-14 w-16 mr-8 text-black" />
                ...
                <div className="border-t border-grey-90">
                  <a
                    ...
                    className="search-dropdown__category button-reset w-full text-grey-53 hover:no-underline hover:bg-grey-96 py-6 px-16 flex items-center"
                  >
                    <Icon className="icon-file" addClassName="text-14 w-16 mr-8 text-black" />
                ...
                <div className="border-t border-grey-90">
                  <a
                    ...
                    className="search-dropdown__category button-reset w-full text-grey-53 hover:no-underline hover:bg-grey-96 py-6 px-16 flex items-center"
                  >
                    <Icon className="icon-community" addClassName="text-14 w-16 mr-8 text-black" />
          ...
          <div className="-mx-24 -my-12 relative">
            <div className="navbar__popup overflow-y-auto">
              <div className="px-24 py-12 flex flex-col">
                ...
                <a
                  className={classnames("group py-4 text-white font-medium hover:no-underline flex items-center")}
                  onClick={() => {
                    setWrapLeft();
                    setSearchValue("");
                    goRoute("/community");
            ...
            <div className={classnames("absolute pin-b pin-r mb-24 mr-24 flex text-24 leading-none", { hidden: !isLogin })}>
              <a
                className={classnames("text-grey-53 hover:text-grey-80 mr-24 cursor-pointer")}
                onClick={() => {
                  goRoute("/settings");
                }}
              >
              ...
              <button
                className={classnames("button-reset text-grey-53 hover:text-grey-80 cursor-pointer")}
                onClick={() => {
                  onLogout();
                }}
              >
      ...
      <div className="flex items-center justify-between md:hidden">
        ...
        >
          <button type="button" className="button button--secondary text-accent text-24 leading-none px-10 py-6" onClick={toggleAddPhotoModal}>
            <svg className="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
      ...
      <div className="hidden md:flex items-center py-16">
        ...
        <div
          className={classnames("w-full ml-8 mr-8 items-center min-w-0", {
            hidden: isLogin,
            flex: !isLogin,
          })}
        >
        ...
        >
          ...
          >
            <a className="block py-4 px-16 leading-sm font-medium text-black hover:no-underline cursor-pointer" onClick={toggleMMenu}>
              {t("common.browse")}
            </a>
          </Menu>
          <a
        ...
        <div className={classnames("flex-none items-center justify-start ml-32 lg:ml-24 flex-grow", { hidden: isLogin, flex: !isLogin })}>
          <a
          ...
          >
            <Icon className="icon-people" addClassName="text-22 align-middle text-black" />
          </a>
        ...
        <div
          className={classnames("w-full mx-24 xl:ml-48 xl:mr-42 relative", {
            hidden: !isLogin,
          })}
        >
          <input
            ...
            onChange={(e) => {
              const value = e?.target?.value || "";
              setSearchValue(value);
              value ? setPCInputTypeMenuRight() : setPCInputTypeMenuLeft();
            }}
          />

          <Icon className="icon-search" addClassName="absolute text-14 pin-l pin-y pin-t-center ml-16 text-grey-27" />
          <div className={classnames("search-dropdown bg-white rounded shadow-popover absolute pin-x pin-t-full mt-8 overflow-hidden z-50", { hidden: !showPCInputTypeMenu })}>
            <div>
              <a
                onClick={() => {
                  onSearch("photos");
        ...
        >
          ...
          >
            <a className="block py-4 px-16 leading-sm font-medium text-grey-53 hover:text-black cursor-pointer" onClick={toggleMenu}>
              <svg className="icon text-24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
