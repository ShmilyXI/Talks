...
const Gallery: FC<GalleryProps> = (props) => {
    ...
    const [
        showGalleryModal,
        { toggle: toggleGalleryModal, setLeft: setGalleryModalLeft },
    ] = useToggle(); // 是否展示画廊选择弹窗
    ...
    const searchGalleryList = (data: string) => {
        const items = mockGalleryList.filter(
            (v) => v?.name?.indexOf(data) !== -1,
        );
        ...
        <div ref={galleryModalRef} className="relative">
            ...
            >
                <span className="off" title="Add to gallery">
                    <svg
                        className="icon button--pill__icon"
                ...
                <span className="on items-center">
                    <svg
                        className="icon button--pill__icon ml-3 mr-8"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 576 512"
                    >
                        <path d="M527.943 224H480v-48c0-26.51-21.49-48-48-48H272l-64-64H48C21.49 64 0 85.49 0 112v288c0 26.51 21.49 48 48 48h400a48.001 48.001 0 0 0 40.704-22.56l79.942-128c19.948-31.917-3.038-73.44-40.703-73.44zM54 112h134.118l64 64H426a6 6 0 0 1 6 6v42H152a48 48 0 0 0-41.098 23.202L48 351.449V117.993A5.993 5.993 0 0 1 54 112zm394 288H72l77.234-128H528l-80 128z" />
            ...
            <div
                className={classnames(
                    "absolute bg-white shadow-popover text-left w-264 z-100 rounded overflow-hidden top-[40px]",
                    {
                ...
                <div className="bg-white flex flex-col h-250">
                    <div className="bg-inherit flex-none border-b border-grey-90 p-8 is-loading--transparent is-loading--md relative">
                        ...
                        <button
                            type="button"
                            className={classnames(
                                "button-reset absolute pin-t pin-r mt-18 mr-18 w-18 text-left",
                                {
                        ...
                        <div
                            className="text-red text-12 leading-sm mt-8 hidden"
                    ...
                    <div className="flex-grow relative overflow-y-auto">
                        <div
                            className={classnames(
                                "absolute pin flex-col align-center justify-center text-center",
                                galleryList?.length ? "hidden" : "flex",
                            )}
                        >
                            <div className="text-14 leading-md text-black font-medium mb-12">
                                No galleries found
                            </div>

                            <div className="w-168 mx-auto text-12 leading-sm">
                                To create a new gallery enter its name and press
                                enter.
                                <span
                                    className={classnames({
                                        hidden: !galleryLock,
                        ...
                        >
                            {galleryList.map((item) => (
                                ...
                                >
                                    <div
                                        className={classnames(
                                            "flex items-center p-8 border-b border-grey-90 cursor-pointer select-none",
                                            {
                                                "bg-selection":
                                                    gallerySelectKeys?.indexOf(
                                                        item.id,
                                                    ) >= 0,
                                            },
                                        )}
                                    >
                                        <div className="flex-none bg-grey-96 rounded w-40 mr-8 overflow-hidden">
                                            <img
                                                src={
                                                    item.imageUrl ||
                                                    "data:image/svg+xml;charset=utf-8,%3Csvg xmlns%3D'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg' width%3D'40' height%3D'40'%2F%3E"
                                                }
                                                width="40"
                                                height="40"
                                                alt=""
                                        ...
                                        <div className="flex-grow min-w-0">
                                            <div className="text-black flex items-center">
                                                <span className="text-14 leading-md font-medium truncate min-w-0">
                                                    {item.name}
                                                </span>
                                            </div>
