...
const Index: FC<Props> = (props) => {
  ...
  const [tempImage, setTempImage] = useState<any>(); // 暂存图片base64
  ...
  const validateFields = (values: any): Promise<any> =>
    new Promise((resolve, reject) => {
      ...
      if (!values?.description) {
        _errorInfo.description = t("photoModal.description_is_required");
      }
  ...
  const onFormValueChange = async (filedName: string, value?: any) => {
    ...
    await validateFields(_formValues);
  };
            ...
            <div>
              <div className="story-form">
                <div className="bg-white -m-16 md:-m-24 sm:rounded-6">
                  <div className={classnames(tempImage ? "on" : "off")}>
                  ...
                  >
                    <div className="w-full">
                      ...
                      <div className="my-16">
                        ...
                        >
                          {t("photoModal.description_is_required")}
                        </div>
                      </div>
                      ...
                      <div className="flex flex-wrap -mb-8">
                        ...
                        <div className="mr-8 mb-8">
                          <Gallery
                            onChange={(value) =>
                              onFormValueChange("gallery", value)
                            }
                            disabled={!isUploadDone}
                          />
                        </div>
                        ...
                        <div className="mr-8 mb-8">
                          ...
                          >
                            <input
                              checked={!!formValues?.commentable}
                              name="is_commentable"
                              type="checkbox"
                              onChange={() => {}}
                            />
                      ...
                      <button
                        ...
                        onClick={onSubmit}
                        // disabled={
                        //   !isUploadDone || !!Object.keys(errorInfo)?.length
                        // }
                      >
