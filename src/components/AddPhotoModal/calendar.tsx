...
const Calendar: FC<CalendarProps> = (props) => {
  ...
  const [showModal, { toggle: toggleModal, setLeft: setModalLeft, setRight: setModalRight }] = useToggle();
  ...
  useEffect(() => {
    ...
    flatPicker(calendarWrapRef.current, {
      wrap: true,
      inline: true,
      appendTo: document?.querySelector("#calendar-modal"),
      enableTime: true,
      locale: "zh",
      nextArrow: ">",
      prevArrow: "<",
  ...
  return (
    <div className="relative z-10 calendar">
      <div id="calendar-wrap">
        <div data-input />
        <button className={classnames("button button--pill", value ? "is-active" : "is-invalid")} type="button" disabled={disabled} onClick={toggleModal}>
          <span title="Select date">
            ...
            <span className="pr-6">{value || t("photoModal.no_date")}</span>
          </span>
        </button>
        <div
