...
const talkApi = {
  ...
  /** 获取讨论详情 **/
  getTalkDetailInfo: async (data = {}) => await baseRequest("/talk/get-detail-info", { method: "GET", data }),

  /** 获取杰出贡献者列表 **/
  getOutstandingContributors: async (data = {}) => await baseRequest("/talk/get-outstanding-contributors", { method: "GET", data }),

  /** 获取未答复讨论列表 **/
  getUnansweredList: async (data = {}) => await baseRequest("/talk/get-unanswered-list", { method: "GET", data }),
